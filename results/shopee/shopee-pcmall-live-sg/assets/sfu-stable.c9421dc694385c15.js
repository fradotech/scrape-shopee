  ...
  [7327],
  {
    92320: (e, t, i) => {
      ...
      var a,
        ...
        C,
        H = i(84898),
        S = "device_sz_fingerprint",
        k = "sz-token",
        P = "af-ac-enc-sz-token",
        A = "x-sz-sdk-version",
        E = "d-nonptcha-sync",
        T = "/verify/traffic",
        x = "/verify/traffic/error",
        D = "/buyer/login",
        F = {
          onInit: () => {},
          onComplete: () => {},
      ...
      var B,
        ...
        V = /beeshop|shopee/i,
        W = /shopee.*app_type=2(\s|$)/i,
        X = /shopee-food-driver/i,
        Q = /shopee-express-driver/i,
        J = /shopeepay|airpay/i,
        Y = /mitra/i,
        G = /seatalk/i,
        K = /shopee-toc-acc-sdk/i,
        $ = /now/i,
        Z = /spinjam.*app_type=20(\s|$)/i;
      ...
      var ee = () =>
        ...
        ((
          e = (() => {
            if (j) return window.navigator.userAgent;
          })()
        ) => {
          if (void 0 !== e)
            return X.test(e)
      ...
      function te(e, t) {
        ...
        var [a, r] = e.split("#");
        return (
          (a = a.indexOf("?") > -1 ? a + "&" + i.substring(1) : "" + a + i),
          r ? a + "#" + r : a
        );
      }
      var ie = [
      ...
      function de({
        history: e,
        redirectType: t,
        shouldReplaceHistory: i,
        absoluteRedirectPath: a,
        relativeRedirectPath: r,
      }) {
        var o, n, s, l;
        t !== h.External && e
          ? i
            ...
            : ee()
            ? null == (o = window) ||
              null == (o = o.WebViewJavascriptBridge) ||
              o.callHandler(
                "navigate",
                (((s = {}).url = a), (s.popSelf = 0), (s.navbar = {}), s)
              )
            : e.push(r)
          : i
          ? location.replace(a)
          : ee()
          ? null == (n = window) ||
            null == (n = n.WebViewJavascriptBridge) ||
            n.callHandler(
              "navigate",
              (((l = {}).url = a), (l.popSelf = 0), (l.navbar = {}), l)
            )
          : (location.href = a);
      }
      function he({
        ...
        next: t,
        appKey: i,
        scene: a = "crawler_item",
        shouldReplaceHistory: r = !0,
        clientId: o,
        redirectType: n = h.External,
        verificationPageHost: s = location.origin,
        antiBotTrackingId: l,
        setRedirecting: c,
      }) {
        (n !== h.External && e) || (c && c());
        var p,
          ...
          v = (0, H.A)(
            ...
            t.includes("__mobile__") || ee() ? { __mobile__: 1 } : {}
          );
        de(
          (((u = {}).history = e),
          (u.redirectType = n),
          (u.shouldReplaceHistory = r),
          (u.absoluteRedirectPath = pe(
            (((d = { isRelative: !1 }).host = s),
            (d.path = T),
            (d.params = v),
            d)
          )),
          (u.relativeRedirectPath = pe(
            (((p = { isRelative: !0 }).host = s),
            (p.path = T),
            (p.params = v),
            p)
          )),
      ...
      function ue({
        history: e,
        trackingId: t,
        shouldReplaceHistory: i = !0,
        redirectType: a = h.External,
        verificationPageHost: r = location.origin,
        homeUrl: o,
        isLoggedIn: n = !0,
        error_type: s,
      }) {
        var l,
          ...
          v,
          f = (0, H.A)(
            { tracking_id: t, is_logged_in: n, home_url: o || location.origin },
            s ? (((p = {}).type = s), p) : {},
            s === R.BINDPHONE || s === R.VERIFYPHONE
              ? (((c = {}).next = location.href), c)
              : {},
            location.origin.includes("xiapibuy")
              ? (((l = {}).origin = location.origin), l)
              : {},
            ee() ? { __mobile__: 1 } : {}
          );
        de(
          ...
          (v.absoluteRedirectPath = pe(
            (((u = { isRelative: !1 }).host = r),
            (u.path = x),
            (u.params = f),
            u)
          )),
          (v.relativeRedirectPath = pe(
            (((d = { isRelative: !0 }).host = r),
            (d.path = x),
            (d.params = f),
            d)
          )),
      ...
      function ve({
        history: e,
        next: t,
        redirectType: i = h.External,
        shouldReplaceHistory: a = !0,
        verificationPageHost: r = location.origin,
        isFromGoogleAdsPDP: o,
        trackingId: n,
      }) {
        var s,
          l = (0, H.A)(
            { next: t },
            t.includes("__mobile__") || ee() ? { __mobile__: 1 } : {},
            o ? (((s = {}).is_from_fu = new Date().getTime()), s) : {},
            { fu_tracking_id: n }
          );
        if (
          (function () {
          ...
          window.SHPLSBridge &&
            (async () => {
              !(await window.SHPLSBridge.checkLogin()) &&
                (await window.SHPLSBridge.login(), window.location.reload());
            })();
        else if (ee()) {
          var c;
          null == (c = window) ||
            null == (c = c.WebViewJavascriptBridge) ||
            c.callHandler(
              "login",
              (((d = {}).redirectPath = te("main", (((p = {}).apprl = t), p))),
              (d.redirectTab = 1),
              d),
              (e) => {
          ...
          if (location.origin.includes("xiapibuy")) {
            var u =
              ...
              v = window.btoa(
                JSON.stringify((((w = {}).next = window.location.href), w))
              ),
              f = re();
            de(
              (((_ = {}).history = e),
              ...
              (_.absoluteRedirectPath = pe(
                (((y = { isRelative: !1 }).host =
                  "https://account.seller." + (U.env[f] || "") + "shopee.com"),
                (y.path = "/signin/oauth/identifier"),
                (y.params =
                  (((g = { account_type: 2 }).client_id = O[f] || O.live),
                  (g.require_passwd = !0),
              ...
              (_.relativeRedirectPath = pe(
                (((m = { isRelative: !0 }).host = r),
                (m.path = D),
                (m.params = l),
                m)
              )),
            ...
            de(
              ...
              (C.absoluteRedirectPath = pe(
                (((R = { isRelative: !1 }).host = r),
                (R.path = D),
                (R.params = l),
                R)
              )),
              (C.relativeRedirectPath = pe(
                (((b = { isRelative: !0 }).host = r),
                (b.path = D),
                (b.params = l),
                b)
              )),
                ...
                (void 0 === fe.Qf &&
                  ((fe.Qg = function (e) {
                    ...
                    for (var s = 0, l = a.length; s < l; s++)
                      r +=
                        "%" + ("00" + a.charCodeAt(s).toString(16)).slice(-2);
      ...
      function _e({
        ...
        setRedirecting: o,
        getRedirecting: s,
        triggerAntiCrawlerCustomizedErrorPage: c,
        triggerAntiCrawlerForceLogin: p,
        triggerAntiCrawlerVerification: d,
        enablePopup: u,
      }) {
        ...
        if (t && e) {
          ...
          if (
            (t[3]
              ? ((M = (O = t)[4]),
                ...
                (X = null == (D = L) ? void 0 : D[1]))
              : ((M = (O = t).challenge_type),
                (N = O.action_type),
                (B = O.tracking_id),
                (W = O.is_login),
                (V = O.error),
                (z =
                  null == (F = O.captcha_extra_info) ? void 0 : F.tracking_id),
          ...
          if (N === l.Block) {
            var Q =
              a === w.SHOPEELIVE ? location.origin + "/pc/setup" : e.homeUrl;
            return void c(
              ((E = {}),
              (E.trackingId = B || ""),
          ...
          if (M === n.Captcha) {
            var J =
              a == w.PC || a == w.RW
                ...
                : e.appKey;
            if (!J) return;
            return void (u && e.usePopupCaptcha
              ? (({
                  appKey: e,
                  scene: t = "crawler_item",
                  clientId: i,
                  shouldReplaceHistory: a,
                  antiBotTrackingId: r,
                  verificationPageHost: o,
                }) => {
                  if (j) {
                    ...
                    s.classList.add("sfu-captcha-modal-body"), n.appendChild(s);
                    var l = document.createElement("iframe"),
                      c =
                        (((g = { is_initial: !0 }).app_key = e),
                        (g.scene = t),
                        (g.client_id = i),
          ...
          if (M === n.ForceLogin) {
            ...
            Z &&
              ...
              (window.BITrack
                ? window.BITrack(
                    (((k = {}).data =
                      (((S = { type: "v3" }).timestamp = new Date().getTime()),
                      (S.info =
                        (((H = { operation: "action_sfu_handle" }).data =
                          (((C = { code: 1 }).scenario = JSON.stringify(
                            (((b = {}).response = t), (b.pathname = i), b)
                          )),
                          C)),
                        H)),
                      S)),
      ...
      var we = (e, t, i, a) => {
          ...
          if (
            a &&
            e.limitMethods &&
            !e.limitMethods.some((e) => e.toLowerCase() === a.toLowerCase())
          )
            return !1;
          switch (e.match) {
            case "contain":
        ...
        be = (e, t, i, a) => {
          for (var r = 0; r < e.length; r++) {
            var o = e[r];
            if (we(o, t, i, a)) return o;
          }
        };
      class Re {
        constructor(e = 20) {
          (this.items = []), (this.maxSize = e);
        }
        enqueue(e) {
          this.size() >= this.maxSize &&
            (this.dequeue(), e instanceof Se && this.items[0].civid),
            this.items.push(e);
        }
        dequeue() {
      ...
      class Ce {
        ...
        serialize() {
          var e = new ArrayBuffer(6),
            t = new DataView(e);
          return t.setUint16(0, this.key), t.setUint32(2, this.timestamp), e;
        }
      }
      class He {
        constructor(e, t, i) {
      ...
      class ke {
        ...
        serialize() {
          ...
          for (i.setUint32(11 + e, this.currentTimeOffset), a = 0; a < 8; a++)
      ...
      var Pe = new Re(20),
        ...
        Ee = new Re(5),
        Te = new Re(5),
        xe = { view: 1, auto_view: 2, click: 3, impression: 4, other: 5 },
        De = {
          item: 1,
          shop: 2,
          voucher: 3,
        ...
        try {
          ...
          Pe.getItems().map((e) => {
            r.includes(e.civid) || "" === e.civid || r.push(e.civid),
              r.includes(e.last_civ_id) ||
                "" === e.last_civ_id ||
                r.push(e.last_civ_id);
          }),
            Ee.getItems().map((e) => {
              r.includes(e.civid) || "" === e.civid || r.push(e.civid),
                r.includes(e.last_civ_id) ||
          ...
          Pe.getItems().map((e) => {
            (null == e ? void 0 : e.serialize) &&
              (c.set(new Uint8Array(e.serialize(r)), p), (p += 34));
          }),
            Ee.getItems().map((e) => {
              (null == e ? void 0 : e.serialize) &&
                (c.set(new Uint8Array(e.serialize(r)), p), (p += 34));
            ...
            Ae.getItems().map((e) => {
              (null == e ? void 0 : e.serialize) &&
                (c.set(new Uint8Array(e.serialize()), p), (p += 8));
            }),
            Te.getItems().map((e) => {
              (null == e ? void 0 : e.serialize) &&
                (c.set(new Uint8Array(e.serialize()), p), (p += 6));
            });
          for (
            var d = btoa(String.fromCharCode.apply(null, Array.from(c))),
              h = "",
              u = 1,
              v = 0;
            v < d.length;
      ...
      function Oe({
        ...
        async function D({ history: r, onFail: o = () => {} }) {
          var s,
            ...
            p,
            d = fe;
          if (a !== w.BANK && (r && (b = r), null == f && null == g && j))
            try {
              n[d(0)].onInit(),
                n[d(1)].onInit(),
              ...
              var h, u;
              x(e), null != (h = (u = n[d(0)]).onFail) && h.call(u), o();
            }
        }
        function F() {
          var e,
        ...
        async function O({ shouldWaitForDfpInit: e = !1 } = {}) {
          try {
            return (
              ...
              v.default
                ? v.default.getClientCheckData()
                : v.getClientCheckData()
            );
          } catch (e) {
            return x(e), d(e), "";
          }
        ...
        async function q() {
          try {
            await f;
            var e = v.default
              ? v.default.getDegradedData()
              : v.getDegradedData();
            return e && "string" == typeof e
              ? [...e].some((e) => e.charCodeAt(0) > 127)
                ? ""
                : e
              : "";
          } catch (e) {
        ...
        return (
          (() => {
            if (j && s && !window.__fu_hook) {
                          ...
                          try {
                            if (
                              ...
                              if (
                                ...
                                var p = "";
                                null !== a.last_civ_id &&
                                  void 0 !== a.last_civ_id &&
                                  (p = a.last_civ_id.replaceAll("-", ""));
                                var d = 0,
                                  h = 0;
                                if (null !== a.data && void 0 !== a.data) {
                                  var u = a.data;
                                  if (
                                    null !== u.viewed_objects &&
                                    void 0 !== u.viewed_objects &&
                                    u.viewed_objects.length > 0
                                  ) {
              ...
              window.fetch = async (...s) => {
                ...
                try {
                  var R,
                    ...
                    I =
                      (k =
                        window.Request && y instanceof Request
                          ? new URL(y.url, window.location.origin)
                          : new URL(y.toString(), window.location.origin))
                        .origin === window.location.origin,
                    O = k.pathname.replace(/\/+$/, ""),
                    B =
                      null == (R = _) || null == (R = R.method)
                        ? void 0
                        : R.toLowerCase(),
                    z = performance.now(),
                    j = !1,
                  ...
                  if (
                    ...
                    !j &&
                      ...
                      Array.isArray(p) &&
                      p.length > 0 &&
                      (j = Boolean(be(p, O, I, B))),
                    j)
                  ) {
                    var W;
                    n.hookFUFetch.onInit(), D({});
                    var X = U(),
                      Q = await q(),
                      J = F();
                    if (window.Request && y instanceof Request) {
                      ...
                      ((m = {}).headers = (0, H.A)(
                        ...
                        (_ = m);
                    (a === w.PC || a === w.RW) &&
                      (!window.__SFUC && (window.__SFUC = 0), window.__SFUC++);
                    var K = performance.now(),
                      $ = Math.floor(K - z);
                    (null == (W = _) || !W.anticrawler) &&
                      n.hookFUFetch.onComplete($);
                  }
                  var Z = await i(y, _);
                  if (!Z || !Z.ok) return Z;
                  try {
                    ...
                    if (j && ee >= 200 && ee < 300 && 204 !== ee) {
                      ...
                      if (te && te.includes("application/json")) {
                        var ie,
                          ae = await Z.clone().json();
                        if (!ae || "object" != typeof ae || Array.isArray(ae))
                          return Z;
                        var re =
                          null != (ie = _) && ie.anticrawler
                            ? _.anticrawler
                            : null == o
                            ? void 0
                            : o[O];
                        _e(
                          ...
                          (v.getRedirecting = T),
                          (v[u(2)] = (e) =>
                            ue((0, H.A)({}, e, { history: b }))),
                          (v[u(3)] = (e) =>
                            ve((0, H.A)({}, e, { history: b }))),
                          (v[u(4)] = (e) =>
                            he((0, H.A)({}, e, { history: b }))),
                          (v.enablePopup = c),
                          v)
                        );
                      }
              ...
              (XMLHttpRequest.prototype.open = function (...e) {
                (this.openargs = e), (this.headers = {}), d.apply(this, e);
              }),
                (XMLHttpRequest.prototype.setRequestHeader = function (e, t) {
                  (this.headers[e] = t), u.call(this, e, t);
                }),
                  ...
                  try {
                    ...
                    if (this.openargs) {
                      ...
                      if (
                        ...
                        var k = await q();
                        if (
                          (!this.headers[P] && this.setRequestHeader(P, k), u)
                        ) {
                          var I = Ie();
                      ...
                      if (this.readyState === XMLHttpRequest.DONE)
                        try {
                          if (
                            ...
                            if (n && !n.includes("application/json")) return;
                            ...
                            if (
                              ...
                              return;
                            var p =
                                l && "text" !== l && this.response
                                  ? this.response
                                  : JSON.parse(this.responseText),
                              u = null == o ? void 0 : o[s];
                            _e(
                              ((f = fe),
                              ((m = {}).antiCrawlerConfig = (0, H.A)(
                                {
                                  redirectType:
                                    a == w.PC || a == w.RW
                                      ? h.Internal
          ...
          (u.l = async function () {
            try {
              await f;
              var e = v.default
                ? await v.default.getLongToken()
                : await v.getLongToken();
          ...
          (u.u = F),
          (u.h = (e) => he((0, H.A)({}, e, { history: b }))),
          (u.v = (e) => ue((0, H.A)({}, e, { history: b }))),
          (u.m = (e) => ve((0, H.A)({}, e, { history: b }))),
          (u._ = O),
          (u.R = async function ({
            shouldWaitForDfpInit: e = !1,
            useHeader: t,
            customDfp: i,
          }) {
            try {
              await f, await Promise.race([g, e ? y : _]);
              var a =
                "string" == typeof i
                  ? i
                  : await O(((n = {}), (n[fe(5)] = e), n));
              return t
                ? a.length >= 300
                  ? {}
                  : (((o = {})[k] = a), o)
      ...
      var Ue,
        ...
        _t,
        wt =
          (((Le = {})["/webapi/v1/shop_page/replay/add"] = {
            shouldReplaceHistory: "false",
          }),
          (Le["/webapi/v1/host_config/permission"] = {
            shouldReplaceHistory: "false",
          }),
          (Le["/webapi/v1/item/my_shop"] = { shouldReplaceHistory: "false" }),
          (Le["/webapi/v1/item/my_likes"] = { shouldReplaceHistory: "false" }),
          (Le["/webapi/v1/item/my_recent"] = { shouldReplaceHistory: "false" }),
          (Le["/webapi/v1/item/parse_url"] = { shouldReplaceHistory: "false" }),
          Le),
        bt =
          (((Ue = {})["/api/v4/microsite/get_items"] = {
            shouldReplaceHistory: "false",
          }),
          (Ue["/api/v4/market_coin/get_product_feeds"] = {
            shouldReplaceHistory: "false",
          }),
          (Ue["/api/v2/add_on_deal/info"] = { shouldReplaceHistory: "false" }),
          ...
          Ue);
      (_t = { policyurl: /api\/v3\/affiliateplatform\/.*/, match: "regexp" }),
        (yt = { policyurl: /api\/pas\/v1\/setup_helper\/.*/, match: "regexp" }),
        (gt = { policyurl: "api/selleradmin/v1/product", match: "contain" }),
        (mt = {
        ...
        (it = { policyurl: "api/crm/v1/product_selector", match: "contain" }),
        (tt = {
        ...
        (Ve = { policyurl: "api/v3/affiliateplatform/gql", match: "contain" }),
        (je = {
          policyurl: "api/tool/mass_product/get_unpublished_product_list",
          match: "contain",
        }),
        (ze = { policyurl: "api/v2/message", match: "contain", allowCors: !0 }),
        (Be = {
      ...
      function Rt({
        ...
        headers: p,
        enablePopup: d = !1,
        handleMaintenanceModeResponse: h,
        policies: u,
        performanceTrackings: v = I,
        onError: f = () => {},
        onJsonResponse: m = () => {},
      }) {
        var g,
          ...
          { i: E, _: T, R: x, v: D, m: F, h: O, o: U, p: L, l: M } = P;
        async function N(e, t, a) {
          try {
                ...
                (0, H.A)(
                  {
                    ...
                    headers: (0, H.A)(
                      {},
                      n,
                      null != t && t.overideCreateSFUHeaders
                        ? null == t
                          ? void 0
                          : t.headers
                        : (0, H.A)({}, p, null == t ? void 0 : t.headers)
                    ),
                  },
                  t && !1 === t.withCredentials
                    ? {}
                    : ((_ = { credentials: "include" }), _),
                  {
                    body: o,
            ...
            if (d >= 200 && d < 300) {
              ...
              if (u && !u.includes("application/json")) return c;
              var v = await c.json();
              return (
                m(v, c),
            ...
            return ((f = {}).error = q.SERVER_ERROR), (f.error_msg = e), f;
          }
          var f, g, y, _;
        }
        async function B(e, t, i) {
          ...
          var s,
            ...
            d = n
              ...
              : {},
            h =
              null != n && n.dataFormatter
                ? n.dataFormatter(
                    null != n && n.useHeader ? d[k] || "" : d[S] || ""
                  )
                : d,
            u =
              (null != i && i.isFormData) ||
          ...
          return await N(
            ...
            (s.headers = (0, H.A)(
              ...
              v,
              null != n && n.useHeader ? h : {},
              { [A]: U() }
            )),
            (s.isFormData = null == i ? void 0 : i.isFormData),
            (s.overideCreateSFUHeaders =
        ...
        return (
          ...
          (R.get = async function (e, t) {
            ...
            var n,
              ...
              c = await (o
                ...
                : Promise.resolve({})),
              p =
                null != o && o.dataFormatter
                  ? o.dataFormatter(c["sz-token"] || "")
                  : c,
              d = a ? P.u() : {};
            return await N(
              e,
              ((n = { method: "GET" }),
              (n.headers = (0, H.A)({}, null == t ? void 0 : t.headers, d, p, {
                [A]: U(),
              })),
              (n.overideCreateSFUHeaders =
                null == t ? void 0 : t.overideCreateSFUHeaders),
          ...
          (R.postForm = async function (e, t, i) {
            var a = new FormData();
            for (var r in t) a.append(r, t[r]);
            return B(e, a, (0, H.A)({}, i, { isFormData: !0 }));
          }),
          (R[b(0)] = function (e) {
            var t;
            j && P.i((((t = {}).history = null == e ? void 0 : e.history), t));
          }),
          (R[b(4)] = O),
          (R[b(2)] = D),
          (R[b(3)] = F),
